...
public class MapsA extends FragmentActivity implements
        OnMapReadyCallback,
            ...
            ActivityCompat.OnRequestPermissionsResultCallback
{
        ...
        fab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                try
                {
                    ...
                    SettingsActivity.setTempServerAccountLocation(String.format("%f,%f,%s,%s",latMyPos.latitude,latMyPos.longitude,addresses.get(0).getLocality(), addresses.get(0).getCountryCode()));
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        String pos= LoginActivity.getServerAccount().getLocation();
        ...
        else
        {
            ...
            myMarker=mMap.addMarker(new MarkerOptions()
                    .position(latMyPos)
                    .title(LoginActivity.getServerAccount().getUsername()).draggable(true)
